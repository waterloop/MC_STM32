...
#define VSENSE_B_Pin GPIO_PIN_2
...
#define ADC_TEMP_4_Pin GPIO_PIN_4
#define ADC_TEMP_4_GPIO_Port GPIOC
#define ADC_TEMP_3_Pin GPIO_PIN_5
#define ADC_TEMP_3_GPIO_Port GPIOC
#define ADC_TEMP_2_Pin GPIO_PIN_0
#define ADC_TEMP_2_GPIO_Port GPIOB
#define ADC_TEMP_1_Pin GPIO_PIN_1
#define ADC_TEMP_1_GPIO_Port GPIOB
