...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA7     ------> ADC1_IN7
    */
    GPIO_InitStruct.Pin = VSENSE_A_Pin|VSENSE_B_Pin|VSENSE_C_Pin|VSENSE_DC_Pin
                          |ISEN_A_Pin|ISEN_B_Pin|ISEN_C_Pin|ADC_TEMP_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA7     ------> ADC1_IN7
    */
    HAL_GPIO_DeInit(GPIOA, VSENSE_A_Pin|VSENSE_B_Pin|VSENSE_C_Pin|VSENSE_DC_Pin
                          |ISEN_A_Pin|ISEN_B_Pin|ISEN_C_Pin|ADC_TEMP_Pin);
